// Auto-generated on Sat Jun 14 10:47:03 PM IST 2025
...
//   * Pipeline 1: 64 bits wide, contains VALU, VELEM
//     Uses 1 128-bit vreg read ports and write port 0
//   * Pipeline 2: 64 bits wide, contains VMUL, VSLD
//     Uses 2 128-bit vreg read ports and write port 1
// - Vector register file needs 5 read ports and 2 write ports
...
package vproc_config;
    ...
    parameter int unsigned VPORT_RD_CNT                = 5;
    parameter int unsigned VPORT_RD_W   [VPORT_RD_CNT] = '{default: VREG_W};
    parameter int unsigned VPORT_WR_CNT                = 2;
    ...
    parameter int unsigned PIPE_W           [PIPE_CNT] = '{32, 64, 64};
    parameter int unsigned PIPE_VPORT_CNT   [PIPE_CNT] = '{1, 1, 2};
    parameter int unsigned PIPE_VPORT_IDX   [PIPE_CNT] = '{1, 2, 3};
    parameter int unsigned PIPE_VPORT_WR    [PIPE_CNT] = '{0, 0, 1};
